 ...
 */
const links = [
  { label: "INTERACT 2026 – Event Payment Details", url: "/event-payment-details" },
  { label: "INTERACT 2026 – On Spot Registration - DAY - 01", url: "https://forms.gle/pE4epE9PuUaoViEa6" },
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-2 text-primary group-hover:text-white transition-colors font-bold">
                  {item.url.startsWith("http") ? <ExternalLink size={18} /> : <ArrowRight size={20} />}
                </div>
              </Link>
            </motion.div>
          ))}
